...
Prtg {
    if ($results | Where-Object { $_.OID -eq "1.3.6.1.4.1.318.1.1.1.3.3.1.0" }) {
        Result {
    ...
    if ($results | Where-Object { $_.OID -eq "1.3.6.1.4.1.318.1.1.1.3.3.2.0" }) {
        Result {
    ...
    if ($results | Where-Object { $_.OID -eq "1.3.6.1.4.1.318.1.1.1.3.3.3.0" }) {
        Result {
    ...
    if ($results | Where-Object { $_.OID -eq "1.3.6.1.4.1.318.1.1.1.3.3.4.0" }) {
        Result {
